...
class UserCreatesOrderTest < ActionDispatch::IntegrationTest
  ...
  test "order creation happy path" do
    ...
    assert page.has_css?(".notice", text: "Julia Child's order for February 20, 2020 13:00 has been created.")
  ...
  test "order creation sad path" do
    ...
    click_on "Create Order"
    assert page.has_css?(".notice", text: "Bob Elder's order for June 22, 2020 02:00 has been created.")
    assert_equal current_path, order_path(Order.last)
