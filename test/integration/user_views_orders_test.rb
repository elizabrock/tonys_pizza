...
class UserViewsOrdersTest < ActionDispatch::IntegrationTest
  ...
  test "view the list of orders, in order of date" do
    ...
    Order.create(customer: customer2, delivery_time: "02/02/2020 5:00PM", location: "66 Orange Grove Way")
    Order.create(customer: customer1, delivery_time: "01/01/2020 12:00PM", location: "1000 Radio Lane")
    Order.create(customer: customer3, delivery_time: "03/03/2020 12:30AM", location: "28 Granny White Pike")
    visit root_path
    click_on "Orders"
    within("ul#orders li:nth-child(1)") do
      assert page.has_content?("Susan Jones")
      assert page.has_content?("January 01, 2020 12:00")
    end
    ...
    within("ul#orders li:nth-child(3)") do
      ...
      assert page.has_content?("March 03, 2020 00:30")
    end
  end
end
