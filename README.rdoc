...
3. Run `rake db:setup,  to create databases locally for development and testing, copy the database schema to your local databases, and import sample data for running the app in development.
4. Turn on the server with `rails s`
5. (optional) Run `rake` (see The Test Suite, below). If everything is set up correctly, rake will pass.
